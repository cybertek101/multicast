...
void doSignature(char *data, int dataLen, EVP_PKEY *pkey, EVP_MD_CTX *md_ctx, uint8_t *signBuff, uint32_t *signLen) {
	int err;
...
void doVerification(char *data, int dataLen, EVP_PKEY *pkey, EVP_MD_CTX md_ctx, uint8_t *signBuff, uint32_t signLen) {
	int err;
